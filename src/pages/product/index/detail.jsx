...
import CategorySelector     from 'pages/product/index/categroy-selector.jsx';
import './save.scss';
                ...
                <div className="form-horizontal">
                    <div className="form-group">
                        ...
                        <div className="col-md-5">
                          <p className="form-control-tatic">{this.state.name}</p>
                        </div>
                    </div>
                    <div className="form-group">
                        <label className="col-md-2 control-label">商品描述</label>
                        <div className="col-md-5">
                          <p className="form-control-tatic">{this.state.subtitle}</p>
                        </div>
                    </div>
                    <div className="form-group">
